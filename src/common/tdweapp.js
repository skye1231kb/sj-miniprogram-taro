...
var _typeof =
  ...
  customConf = require("./tdweapp-conf.js"),
  ...
  TDID = {
    ...
    init: function() {
      ...
      if (n) {
        ...
        new Promise(this.getOpenid)
          .then(function(n) {
            var i = void 0;
            t ? (i = t) : ((i = n), Util.Store.set("deviceId", n)),
              e.setData(i, n),
            ...
            wx.getStorage({
              ...
              success: function(t) {
                Util.getRequestData(t.data),
                  wx.removeStorage({ key: e, success: function(e) {} });
              }
            });
          });
    },
  ...
  pageHandle = {
    ...
    show: function() {
      ...
      "" !== pageHandle.curPagePath &&
        ...
        (pageHandle.curPagePath = t.__route__),
        (pageHandle.pageTime = Util.timestamp()),
        (pageHandle.pageQuery = t.options);
    },
    hide: function() {
